...
public class CamikonShotOverlay extends AbstractOverlay{
    ...
    public void renderText(GuiGraphicsExtractor guiGraphics, int width, int height){
        ...
        // CENTER BOTTOM
        guiGraphics.centeredText(minecraft.font, info, width / 2, height - 20 - minecraft.font.lineHeight, 0xFFFFFFFF);
        // LEFT
        guiGraphics.text(minecraft.font, rec, 30, 30, 0xFFFFFFFF); // TOP
        guiGraphics.text(minecraft.font, cam, 30, height - 28 - minecraft.font.lineHeight, 0xFFFFFFFF); // BOTTOM
        // RIGHT
